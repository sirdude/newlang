...
=item 1. Simple consistent language.
	don't have multiple syntaxes for or, if statements, comments

=item 2. Avoid sigual for variables.
...
=item 5. Compiler should have a built-in perlcritic type functionality.

=item 6. Avoid common programming issues.

=item 7. Strongly typed.

=item 8. Should have built-in string type.
...
src			Current source code for bnfc starting with trying
			...
			so for now this doesn't line up with the documentation.
