...
=item Compiled code	XXX Need to look at how dgd separates this and data 
		files
...
operate on objects: 
	clone_object, compile_object, compile_library, 
	destruct_object, file_name, find_object, object_name
